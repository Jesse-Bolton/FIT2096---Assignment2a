...
public:
	...
	Vector3 GetDirection() { return m_lookAtTarget; }

	Vector3 GetPosition() { return m_position; }

	Vector3 GetPositionLockedY() { return Vector3(m_position.x, 0.0f, m_position.z); }

	Vector3 GetLookAtTarget() { return m_lookAtTarget; }
